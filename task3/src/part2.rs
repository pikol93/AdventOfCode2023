...
pub fn part2(input_text: &str) {
    ...
    let sum = engine_schematic.symbols
        ...
        .filter_map(|symbol| {
            ...
            Some(
                first_part_number.value * second_part_number.value
            )
        })
        .sum::<u32>();
